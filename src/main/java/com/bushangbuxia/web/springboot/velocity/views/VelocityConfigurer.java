...
//	private static final String SPRING_MACRO_LIBRARY = "com/kalman/springboot/velocity/views/spring.vm";
...
//		velocityEngine.addProperty(
//				VelocityEngine.VM_LIBRARY, SPRING_MACRO_LIBRARY);  //for the path not found,so ignore the code.
