...
//		setExposeRequestAttributes(true);
	 ...
	 * of this view, or {@code null} if not needed. DateTool is part of Velocity
	 * Tools 1.0.
	 * 
	 ...
	 * context of this view, or {@code null} if not needed. NumberTool is part of
	 * Velocity Tools 1.1.
	 * 
	 ...
	 * to automatically load a Velocity Tools toolbox definition file and expose all
	 * defined tools in the specified scopes. If no config location is specified, no
	 * toolbox will be loaded and exposed.
	 * <p>
	 * The specified location string needs to refer to a ServletContext resource, as
	 * expected by ServletToolboxManager which is part of the view package of
	 * Velocity Tools.
	 * <p>
